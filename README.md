...
NyaaCat 从 Minecraft 的玩家群体发展而来，是一个开放性、多元化的游戏玩家社区。目前，社区仍运营着数个游戏服务器，包括但不限于喵窝、毛线和其他主题 Minecraft 服务器，泰拉瑞亚、星界边境、CS:GO 服务器等。
...
申请喵窝白名单请先阅读[白名单申请](wiki/whitelist-application.md)。
