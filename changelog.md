...
## 2020
### 2020-9-4 服务器物理架构更新
- 喵窝主服务器迁移至一台新机器。配置包括一枚Core i9-9900K CPU。
- 活动专用服务器 `act` 也迁移至另一新机器。其中包括Core i5-10600K CPU。
- PvP、NFS、美羽实验室等，迁移到了主服务器原先的平台上。该平台由一枚Xeon E3-1271 v3 CPU驱动。
