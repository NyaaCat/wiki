...
## 2020
### 2020-3-12 服务器资源包上线
- 插件Resource-pack Over The Air [(ROTA)](https://github.com/NyaaCat/ROTA)开始启用。自此，出现了定制材质的道具。
- 所有玩家自此日起，登录后将强制检查、下载资源包。由于某些缘故，下载过程时有卡顿，期间无法控制人物。开发组已给出[临时解决方案](https://bbs.nyaa.cat/d/1574)。
