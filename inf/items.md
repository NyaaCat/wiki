...
- [防具](inf/items/armor.md) —— 抵御致命伤害（附加属性提升）
- [近战武器](#)*（暂无详情）* —— 如果你足够勇猛的话
- [远程武器](#)*（暂无详情）* —— 走敌人的路，让敌人无路可走
  + [弹药](#耗材简述) —— 远程武器所必需
- [魔法武器](inf/items/magic.md) —— 同上，弹药变成了魔力
- [召唤武器](#)*（暂无详情）* —— 召唤同伴并肩作战
- [辅助道具](inf/items/support.md) —— 加血、回蓝，以及各种意想不到的玩法
...
装备一般按强度划为 7 个等级，对应 [黑化怪](inf/mobs.md) 的 6 个阶段和 Boss。其中：
- T1 ~ T5 装备：各对应黑化怪前 5 个阶段，铸造池相互独立。
- T5+ 装备：又称「红名」，与 T5 级共享同一铸造池，但十分稀有。对应黑化怪 T5 阶段（较强）。
- Boss 套装：最为稀有，不可铸造，足可单列。对应精英怪 T5+ 阶段、Boss。
...
- 魂玉决定了铸造产物的类型。分别有：
  ...
  + <span style="color:#f9a825;">**炽金魂玉** → 召唤武器</span>
