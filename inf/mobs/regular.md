...
所有普通黑化怪必掉**一文大钱**，部分可掉落**限定物品**。以下将有限定物品的怪物单独列出，并按原型种类归类。  
👉[无限定物品者列表](#暂无限定掉落物的怪物)
...
- 【分布范围与等级】
  + 雪原（19-20）
- 【攻击特征】近战攻击，带有**吸血**效果，并附加「凋零」debuff。
...
- 【分布范围与等级】
  + 远梦华镇前（1-5）
  + 神社门前的森林（9-16）
- 【攻击特征】中距离攻击，带有**吸血**效果<sup>（造成真实伤害并治疗自身，下同）</sup>。**持续向玩家传送移动。**
...
| **小猫猫（AWSL）** | 猫 | 西海之巅（9-12） | *不明* |
| **汪汪卷（摇尾巴）** | 野狼 | 摩多地表（13-16） | *不明* |
