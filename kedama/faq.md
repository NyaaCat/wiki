...
| 常见疑问 | 直达传送门 |
|-|-|
| 毛线是什么 | 👉 [毛玉线圈物語](beginners-guide)服务器的简称。|
| 毛线服务器对客户端有特别的要求吗？ | :point_right: [如何准备客户端](beginners-guide#入服准备)。 |
| 我有点卡 | 👉[服务器连线相关](faq#技术性问题-idtechnical)。|
| 我是新玩家，我应该去哪生存？ | :point_right:[新手上路](beginners-guide#新手上路) |
| 我该怎么赚钱？ | :point_right:[每个卷都要精打细算](beginners-guide#每个卷都要精打细算) |
| 如何去其它维度（世界）？ | :point_right:[维度列表](worlds)<br />要摆传送门请往下翻\~ |
...
喵毛服务器[特殊附魔](/*未有此页面*/) (此页面未完成) 工具兼有高实用性和获取难度，1500卷可以考虑入手。
</br></br>
...
是的，所有资源均产自生电与人工收集。不可再生资源大多来自不定期重置的 vx 世界
</br></br>
