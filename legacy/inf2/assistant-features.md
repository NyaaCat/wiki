...
![indicator](../../assets/images/legacy/inf2/indicator-RAGE-MANA.png)  
...
月耀城、千仞台的[训练场](legacy/inf2/lunar-flare.md#训练场)，可生成若干「傀儡」标靶，用于测试武器输出。生成后，该功能以“Boss 生命条”的方式，显示「傀儡」所受的当前每秒伤害量（DPS）、总伤害量（Total）、DPS 峰值（Max）。

指示条则直观、动态地显示当前 DPS，最大 2048 点（如被 DPS 峰值突破，则修改成该峰值）。

![DPS](../../assets/images/legacy/inf2/indicator-dps.png)
