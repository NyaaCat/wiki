...
**"节操“**是这里的硬通货。初来乍到，服务器娘<span style="background-color: #333333; color: #333333;">小赤佬</span>首先会赠送450节操，作为礼物。
...
“回城卷轴”等道具亦可实现传送。其一般无需节操，但可能存在其它使用限制。
