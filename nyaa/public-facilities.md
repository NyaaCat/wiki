...
| 标准发电厂 :arrow_down_small::battery:         | 作为主世界猪人塔使用，生产腐肉、金粒      | 特区东部 `(-7490, 4540)` *入口在中间突出部分西侧的一个开口*  |
...
| 发光墨囊农场 :battery: | 生产发光墨囊 | `(-7721, 4777)` |
| 树脂厂 | 生产树脂团并自动合成树脂块 | `(-7671, 4780)` |
| 十六色全自动羊毛农场 :battery: | Dao_Mouse 建造的十六色全自动羊毛生产装置 | `(-7809, 4662)` |
...
| 小型羊毛机 | 生产16色羊毛 | *海猫*`Rimo` | 主世界`(-3894,1813)`      | 地狱基岩上层传送门`(-565,470)`到达海猫岛后，步行至`(-4480,3625)`           |
| 热带鱼塔 | 生产热带鱼桶、热带鱼干 | *海猫*`Rimo`<br/>`CitingNutria` | 主世界`(-4640,3700)`      | 地狱基岩上层传送门`(-565,470)`到达海猫岛后，步行至`(-4640,3700)`，跳进金字塔并利用珍珠进入           |
