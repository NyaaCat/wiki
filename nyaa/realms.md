...
如果您想要建立村落，请先确保有至少三名活跃玩家、一个大致村落范围和一份简要规划。  
向管理员申请并建立村落后，请在此页面添加相应的村落信息，并在[这个目录](https://github.com/NyaaCat/wiki/tree/master/nyaa/realm)下添加你的村落的详细信息页面（或委托现有编辑添加）——包含村落简介，基本规划，建筑风格，地下挖掘要求等，并将对应页面链接到这里。
...
* 城主：光光 `Scvlolipop`，罗米 `Docter\_Quin`
* 简介：独立弥漫灏气中，倍饶云雾杳重重。
