...
特区的基础建设由建筑师曲奇 `Round_Cookies` 率先建造。先前，其将此规划为“科幻”风格，后停止建设长达两年有余；直至 2019 年 5 月 15 日，特区由凤凰卷 `phoenixlzx` 征用，转型为近未来工业城市。
...
!> 出于节约服务器算力的考量，目前推荐在北风城使用「一文大钱」[兑换各种木材](space/npc?id=固定-npc)。
...
记录科技特区以外公开公用的工业生产设施。这些设施通常由于游戏机能限制而建设在科技特区之外，可能归属于个人、集团、聚落等，并开放使用权限。  
使用这些设施请注意遵守所在地区的要求。  

| 设施 | 简介 | 位置 | 交通 |
|-|-|-|-|
| 末地蜜蜂农场 | 生产蜜蜂产品，繁殖蜜蜂<br>所属：[无极限拉玛集团](https://bbs.nyaa.cat/d/1644/2) | 末地出生点附近 | `/mvtp world_the_end` |
| 静静渔场 | 生产守卫者之主要战利品<br>by `Leon_Xu` | 主世界 `(5300, 4965)` | 万华街传送站可直达 |
| SK 反应堆 | 潜影贝刷怪塔<br>所属：松木泉 | 主世界 `(4906, 5091)` | 万华街传送站至松木泉，行至此处 |
| 小黑塔 | 生产末影珍珠<br>by `Xianken` | 末地 `(25, -300)` | 从末地出生点向北飞行 |
| 制冰场 | 生产冰<br>by `tcdw` | 主世界 `(318, -3629)` | 新北商城以西 500 米（毛熊村以南） |
| 猪灵交易所 | 生产各种猪灵交易产物<br>by `tcdw` | 下界 `(40, -400)` | 从北风城下界传送门进入下界，然后一路向北走 |

## 工业发展和建设规则

1. 如未特殊说明，工业生产设施为喵窝全体玩家所有，应当共同爱护、维护并协调改进。
1. 如无特殊必要，工业生产设施应建设在工业大厦内。
1. 工业大厦的风格以钢筋混凝土（混凝土/石英）和玻璃为主，在外部即可看到生产设施的状态为佳。
1. 公共生产设施的产出为实际投入原料并运作的玩家所有。如此过程涉及多名玩家，请自行协商分配。
1. 生产设施的设计应首选最高效率且最低算力消耗的方案
1. 每个生产设施单元不宜过大。如需要提高产量，请建设多个单元。
1. 每个生产设施单元应有独立的开关控制。不需要生产时，整个设施应处于关闭状态。
1. 由于 TNT 无法在主世界破坏方块，需要使用 TNT 的生产设备应在科技特区中建设原型机，并按需复制到 Epic 等资源世界使用。可联系管理员协助此操作。
1. 使用流水管道替代传统漏斗降低算力消耗。对于高产设备，应有独立的管道并避免接入分类机。
1. 对于需要大量物品、较远距离传输的生产设施，可提供折跃门支持。
1. 为避免造成持续卡顿影响游戏，任何与实体有关的生产设施不得造成实体积压，过度密集的实体将自动窒息死亡。
