...
~~目前其作为**猪人塔**使用，生产腐肉、金粒及经验球，也是主世界获取经验最快的场所。~~ 现已停摆。
...
| 设施 | 简介 | 位置 | 交通 |
|-|-|-|-|
| <s>末地蜜蜂农场</s> | ~~生产蜜蜂产品，繁殖蜜蜂~~<br />因服务器限制，此设施已停摆。<br>所属：*小爱 `Bersella_AI`* | 末地出生点附近 | `/mvtp world_the_end` |
| 北沼蜜蜂农场 | 生产蜜脾，作为末地农场的替代<br />所属：*小爱 `Bersella_AI`* | 主世界 `(-2000, -4800)` | 自北沼居民区一路向东 |
...
1. 由于 TNT 无法在主世界破坏方块，需要使用 TNT 的生产设备应在科技特区中建设原型机，并按需复制到 Epic 等资源世界使用。可联系管理组协助此操作。
