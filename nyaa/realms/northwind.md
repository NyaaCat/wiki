...
- 废烟、炉渣集中处置，部分转移至生物质能车间，在等待期间缓慢产出更多燃料，实现碳中和、零碳排放。
...
3. 天花板上有燃料指示：
   - <span class="nw-mark-green">绿灯</span> :green_circle:——燃料充足，余量三盒以上
   - <span class="nw-mark-yellow">黄灯</span> :yellow_circle:——**燃料不足**，剩余 1～3 盒
   - <span class="nw-mark-red">红灯</span> :red_circle:——**燃料严重不足**，余量 1 盒以下
   - 三盏全灭，且入口处灯亮——**燃料耗尽**
   - 当“燃料不足”信号发出时，需尽快补充燃料。到对面平台处投放**装满干海带块的潜影盒**，一次 1～14 盒。
     在投放点上方有一电灯，指示燃料装填区是否有盒子；如该灯常灭，需按下一侧按钮以恢复装填。
4. 厂房中央处等待产品集满。天花板上有窗口，可观察熔炉是否正在工作。
5. 厂房同时加工来自生物质能反应车间的海带（绿、粉色标记），无需手工打理。产物将间歇填充到主燃料仓，溢出者可于厂房中央处收集。
