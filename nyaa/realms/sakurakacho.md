...
此外，应**在每次服务器版本更新后，及时维护店面**——部分商品可能因插件的下线而失效。

万华街最终负责人为*静琴*  `shizukoto`  。其会不定期清理久未补货之店铺（上一次是2018年4月）。  
门牌号和《[店铺导览图](https://docs.qq.com/sheet/DV2tHUkFJSkxoQkFp?tab=BB08J2)》暂由*小爱*  `Bersella_AI`  负责维护。

!> **门牌如何重写？**

记住门牌号（假设为“南街 一条39号”），然后手持一块告示牌，执行以下命令：  
```
    /u signedit 1 `&e&l&n南街 一条39号`
    /u signedit 3 &f&o[你的游戏ID]
  ```
将分别于第一行、第三行刻下门牌号及店主 ID。（注：如使用白桦木告示牌，可省去`&e` 和 `&f`。）  
拆除旧门牌，将此贴上原处即可。  
如有 2~3 人合作经营同一铺面，可在第二、四行再登记其余店员的游戏 ID，命令与上述类似。

#### 在万华街寻宝

万华街各处散落着多达 20 多个宝箱，它们会从海底、矿井、地牢等源源不断送来战利品……祝你好运！  
如果发现宝箱里是空的，那兴许被人转运到北街的一处公共仓库里了。哦对了，那里好吃的特别多。
...
~~也设有传送中心 `(207, 38, 300)`，传送牌总共22个，可传送至一些热门聚落；但空位价格达 30 万节操左右，为全窝最高。~~ 传送中心已停止服务。

设有**五个入口**，其中一个位于大神殿正南方，由此进入一级车站及传送中心最快，坐标：`(121, 287)`。其余入口分别位于大神殿正东、万华街（南街）、出征楼、二级总站。

#### 二级铁路总站

位于大神殿以北 `(160, 44)`。主要通往近畿丛林线诸站，包括**胤月庭、要塞**等。
...
- 在易用性和美观的基础上，允许对房屋进行少量改造。除管理组许可，不得大规模修改或重建房屋，不得更改房屋支撑结构。
...
* 出征楼是喵窝现存历史最古老的建筑之一（[2014 年 7 月以前就已经存在<sup>（存档截图）</sup>](/assets/images/legacy/nyaabbs/275--.webp ':ignore')），在樱华町经过数次改造之后，依然保留着它原来的模样。
* 樱华町地下曾经有一个大型驿站，可容纳**大量**玩家临时居住，但为了提升游戏帧率而被拆除，地下也被全部填实。
  * 此驿站于 2018 年 2 月 25 日 [回归<sup>（存档截图）</sup>](/assets/images/legacy/nyaabbs/1231--.webp ':ignore')（期间限定）。
