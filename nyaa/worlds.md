...
喵窝斗士终于将黑化怪物赶进[镇妖塔](wiki/server-network?id=infinite-infernal-world "无尽地狱服务器")<sup>~（沙箱环境）~</sup>。黎明降临大地。**基于1.15.x默认地形的美丽新世界**现已开放。    
...
此末地仅作采集资源、屠龙之用。需要以命令或 CapCat 传送牌进出。
