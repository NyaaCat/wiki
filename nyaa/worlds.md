...
2025 年 9 月起，`/mvtp` 指令权限回收，请查看下文内容了解不同维度的来往方法。
...
因应 2025 年 9 月起的指令权限调整，如需前往末地，可使用下列主世界入口：

| 坐标| 所在地点/聚落| 距大神殿直线距离| 类别 | 备注 |
| - | - | - | - | - |
|(764, 525)|野外|713|天然要塞改造|从入口直接跳下去即可|
|(-51, -570)|二级铁路“要塞”站 |763|天然要塞改造|坐标为二级铁路站点，入口在出站后的 附近|
|(-541, 565)|某玩家咕掉的建筑 |793|天然要塞改造|改造程度低，前往地下后需自行寻找传送门|
|(219, -2336)|北风城|2535|人工要塞|进入建筑后右拐|
|(2896, 2939) |亡灵幻境|3903|天然要塞改造|进入地下部分后，中间别墅楼梯背面有按钮，按下打开通道|
|(-3817, -120)|红魔城|3973|人工传送门|一格式迷你传送门|
|(2245, -7206)|野外|7666|人工传送门|疑似粘贴结构，不保证长期存在|
...
截至 2025 年 9 月，由于 Multiverse 相关指令权限被回收，需使用 `/town select` 指令付费前往该世界。
...
截至 2025 年 9 月，EpicNether 的下界传送门无法使用，请使用 `/home`、`/spawn` 或 `/espawn` 指令退出该世界。
...
截至 2025 年 9 月，EpicEnd 的末地传送门会将玩家传送至 EpicWorld 的出生点。
