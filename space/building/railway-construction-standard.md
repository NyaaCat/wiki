...
喵窝铁路工程延续数年，截至2019年7月，地面大部分路段皆已通车达三年以上；下界交通网大部业已通车近二年。由于一直未达成建设规范共识，不同建设者在不同时期各行一套标准，致使多种标准并存；其中有的设计不甚人性化，相当影响用户乘坐体验。

*无限 `iDemkors`*凭借多年实践经验，以及全服前三的总行驶里程，在原“南方铁路集团”等前辈之基础上，提出全新建设规范与标准。
...
- **轨道组成：**一般为双轨。
  ...
  + 铺设方案①：每11米铺设【探】x1→【金】x3→【普】x7。
  + 铺设方案②：每21米铺设【探】x1→【金】x1→【普】x6→【探】x1→【金】x6→【普】x6。  
  ![Example-Secondary-2](../../assets/images/building-tutorial/railway-construction-standard/example-Secondary-2.png)
  + 铺设方案③（新北市/千里田周边）：每4\~6米铺设【探】x1→【金】x2→【普】x1\~3。
  + 铺设方案④（新北市周边）：每8\~9米铺设【探】x1→【金】x2→【探】x1→【金】x2→【普】x3\~4。
  + 铺设方案⑤（南城地铁/馥雅周边）：每23米铺设【探】x1→【金】x2→【普】x20。

?> :heavy_check_mark: 综合考虑材料开销、实用性、防逆行能力等方面，推荐铺设方案②。  
③④⑤仅当在维护当地线路时，予以考虑。

?> :information_source: 上坡路段建议全程采用加速铁轨，并通电。
...
| 东西向 | ![Example-Guidance-WE](../../assets/images/building-tutorial/railway-construction-standard/guidance-sign-WE.png) | ``` /nu se sign 0 `&e&l<= 本线下一站` ``` <br />`/nu se sign 1 &e&l&n阁楼` <br />`/nu se sign 2 &f&n往东海望` |
