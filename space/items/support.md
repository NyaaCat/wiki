...
以下道具皆由以下 NPC 提供：
- 位于**樱华町**的游商 NPC「御魂匠」
- 位于**北溪台**「望海潮麦当劳」的 NPC「Chef Steve」
...
- 无使用限制
- **【作用】**持于主手或副手栏时，按住潜行键，可持续获得「漂浮」效果；该效果允许你在当前高度的空中行走（但不会上升或下落）。
  + **注意：该物品无法在 [无尽地狱世界](inf/index)（`inf`）使用。**
...
- 【最大能量值】32
- 【是否可充能】是，需海晶砂粒
- **【作用】**雨天时，右键使用，使天空放晴。<br />注意：如在雷雨天使用，雷雨天气**总会**在若干分钟后取代晴天。参考 `/weather clear` 命令使用后的后续效果。
...
![item](../../assets/images/items/support/麦辣鸡盒.png)

- 【外形】木桶
- 【兑换需求】绿宝石块 x4，熟鸡肉 x16
- 【最大能量值】256
- 【是否可充能】是，需熟鸡肉
- **【作用】**
  + 左键使用，即可立即补充 5 点饥饿值与 10 点饱和度。饱和度最高**可叠加**至 20（*Minecraft* 的上限）。
  + 注意：当能量耗尽时，道具**会损毁**。

#### 铁板烧肉桶

![item](../../assets/images/items/support/铁板烧肉桶.png)
...
- 【是否可充能】是，需牛排
- **【作用】**
  + 左键使用，即可立即补充 4 点饥饿值与 6 点饱和度。饱和度最高**可叠加**至 20（*Minecraft* 的上限）。
  + 注意：当能量耗尽时，道具**会损毁**。
