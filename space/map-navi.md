...
?> 图片使用 WebP，需要使用**最新版** <span style="cursor: help; border-bottom: 1px rgba(0, 0, 0, 0.4) dashed" title="包括其它基于 Chromium，且内核版本 ≧32 的浏览器">Chrome</span> 或者 FireFox 浏览器打开。[详情](https://caniuse.com/#search=webp)。
