...
如果需要探索相关地形、获取资源，请移步至 [EpicWorld](nyaa/worlds?id=美丽新世界（原黑化世界）)。

#### 那些美观的建筑，都是在生存模式下建造的吗？

喵窝维度的建筑，有在生存模式下建造的，也有在创造模式下建造的。不过，[2019 年 2 月 1 日](changelog?id=_2019-2-1【用户组改革】) 以后新增的建筑，几乎都是在生存模式下建造的。
