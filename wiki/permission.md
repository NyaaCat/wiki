...
2019年2月1日起，用户组由六个精简为三个。原隶属于“建筑师”、“创造组”或“城主”的玩家，按活跃度划归“玩家”或“高级玩家”**_（待验证）_**。
...
**注意：提醒开始后限 2 分钟内领取。**
        ...
        *   设置家 `/sethome` ；删除家 `/delhome` ；回家 `/home` ；通过右键床设置出生点
...
*   多世界插件，包含功能：
    ...
    *   去往其它世界（需传送门或[传送牌](tutorial/teleport-capcat.md)）

        *   查看世界列表 `/mv list`

*   喵窝辅助工具，详见 【[NyaaUtils 插件指南](tutorial/nyaautils.md)】

*   仓鼠症插件，包含天喵商城（世界商店）、木牌商店、拍卖、征购等。详见 【[HamsterEcoHelper 插件指南](https://wiki.nyaa.cat/books/%E7%8E%A9%E6%B3%95%E6%95%99%E7%A8%8B/page/hamsterecohelper)】

*   传送牌(Capcat) 插件，详见【[指南](tutorial/teleport-capcat.md)】

    *   可购买及释放

*   银行(NyaaBank) 插件，详见【[联合银行](https://wiki.nyaa.cat/books/%E4%B8%96%E7%95%8C%E8%AE%BE%E5%AE%9A/page/%E5%96%B5%E7%AA%9D%E8%81%94%E5%90%88%E9%93%B6%E8%A1%8C "喵窝联合银行")】
*   多出生点(Ourtown) 插件，包括：
...
*   Essentials 核心插件。包含功能：
    ...
    *   修改昵称并使用色彩 `/nick`
        ...
        *   设置最多2个家 `/sethome [home-name]`

        *   删除家 `/delhome [home-name]`
...
详见页面【[管理员](https://wiki.nyaa.cat/books/administration/page/%E7%AE%A1%E7%90%86%E5%91%98 "管理员")】。

* * *

### 已弃用之用户组

以下三种用户组，客观上曾对喵窝建设起到促进作用；现已停用，**在此仅作考古依据**。
