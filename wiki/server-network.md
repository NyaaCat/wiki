...
Nyaa UBW 是喵窝的创造服务器，所有玩家均为创造权限。同时还设置独立的 `test` 服务器供玩家练习和测试，**测试用世界没有备份，请不要建造重要工程**。<br />
...
当*Minecraft* Java正式版发布了重大更新，因插件跟进、性能评估等因素，主服务器并不会第一时间升级。此时，可能会开放独立服务器，以供玩家**抢先体验**原版新特性。  
此世界仅供测试，不设备份，请勿建造重大工程。

- 当前版本：`1.16`
- 使用此地址登录：`116.nyaacat.com:25565`，不支持从主服务器跳转。
- 请遵守基本游戏规则与社区礼仪。
